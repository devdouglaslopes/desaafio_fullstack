...
--
-- Host: 127.0.0.1
-- Tempo de geração: 21-Jun-2022 às 00:10
...
CREATE TABLE `tbcadastro` (
  `codusu` int(9) UNSIGNED NOT NULL,
  ...
  `por_onde_soube_do_evento` varchar(50) DEFAULT NULL
...
CREATE TABLE `tblogin` (
  `codlog` int(9) UNSIGNED NOT NULL,
...
INSERT INTO `tblogin` (`codlog`, `email`, `senha`) VALUES
(1, 'isabel@gmail.com', '1234'),
(2, 'douglas@gmail.com', '1234');
...
--
ALTER TABLE `tbcadastro`
  MODIFY `codusu` int(9) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT de tabela `tblogin`
--
ALTER TABLE `tblogin`
  MODIFY `codlog` int(9) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
COMMIT;
